							 ...
							 <tr align='center'>
							    ...
							    <!---------	 
								 <td>
								   ...
								   <input name='charge_amount' type='hidden' value='38'>
								 ...
								 <td>
								   ...
								   <input name='charge_amount' type='hidden' value='75'>
     ...
     if(isset($_REQUEST['search_room_reports']))
	   {
		  ...
		  if($_REQUEST['cashier']=="ALL")
		    {  
		      $sxx1="select * from room_status where timein>='$start' and timeout<='$end' order by timein desc";
		    }
	   else {
              $sxx1="select * from room_status where timein>='$start' and timeout<='$end' and timein_by='$cashier' order by timein desc";
	        }
     ...
     if(isset($_REQUEST['search_date_range']))
	   {
		  ...
		  if($_REQUEST['cashier']=="ALL")
		    {  
		       $sxx="select * from room_charges where charge_date>='$start' and charge_date<='$end' order by room_no asc, charge_date desc";
			   $sxx1="select sum(amount) as atotal from room_charges where charge_date>='$start' and charge_date<='$end'";
			}
	   else {
		       $sxx="select * from room_charges where charge_date>='$start' and charge_date<='$end' and charge_by='$cashier' order by room_no asc, charge_date desc";
